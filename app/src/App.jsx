    ...
    <div className="min-h-screen" style={{ fontFamily: "'DM Sans','Helvetica Neue',Arial,sans-serif", background: "linear-gradient(135deg, #f0f7ff 0%, #ffffff 60%, #fff7f0 100%)" }}>
      ...
      <header className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Btn variant="primary" onClick={() => setPage("register")}>Get Started <ArrowRight size={14} /></Btn>
        </div>
      </header>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Btn variant="primary" size="lg" onClick={() => setPage("register")}>
                <Gift size={16} /> Create Your Account
              </Btn>
              <Btn variant="outline" size="lg" onClick={() => setPage("login")}>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <button onClick={() => setPage("login")} className="font-semibold hover:underline" style={{ color: BLUE }}>Log In</button>
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <button onClick={() => setPage("register")} className="font-semibold hover:underline" style={{ color: BLUE }}>Sign Up Free</button>
          </p>
